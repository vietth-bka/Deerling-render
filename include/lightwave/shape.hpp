...
/// @brief some available spherical sampling methods
enum class SphereSamplingMethod { Uniform, CosineWeighted, UniformCone }; 
...
public:
    ...
    virtual AreaSample improvedSampleArea(const Point &origin, Sampler &rng) const { NOT_IMPLEMENTED }
